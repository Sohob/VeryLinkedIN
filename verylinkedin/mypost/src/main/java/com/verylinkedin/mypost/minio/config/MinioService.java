 ...
 * All methods return an {@link com.verylinkedin.mypost.minio.config.MinioException} which wrap the Minio SDK exception.
...
public class MinioService {
     ...
     * @throws com.verylinkedin.mypost.minio.config.MinioException if an error occur while fetch object
     */
    public InputStream get(Path path) throws com.verylinkedin.mypost.minio.config.MinioException {
        try {
     ...
     */
    public StatObjectResponse getMetadata(Path path) throws com.verylinkedin.mypost.minio.config.MinioException {
        try {
     ...
     * @throws com.verylinkedin.mypost.minio.config.MinioException if an error occur while fetch object
     */
    public void getAndSave(Path source, String fileName) throws com.verylinkedin.mypost.minio.config.MinioException {
        try {
     ...
     *
     * @param source Path with prefix to the object. Object name must be included.
     * @throws com.verylinkedin.mypost.minio.config.MinioException if an error occur while removing object
     */
    public void remove(Path source) throws com.verylinkedin.mypost.minio.config.MinioException {
        try {
